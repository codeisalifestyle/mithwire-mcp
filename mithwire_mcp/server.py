"""MCP server exposing mithwire browser automation tools."""
...
def create_server(
    *,
    ...
    mcp = FastMCP(
        name=SERVER_NAME,
        instructions=(
            "Stealth mithwire browser MCP server. "
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "webgl_renderer); see session_set_fingerprint. "
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="mithwire-mcp",
        description="Stealth mithwire browser MCP server.",
    )
    parser.add_argument(
        "--transport",
