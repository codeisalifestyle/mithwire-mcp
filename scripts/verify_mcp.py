#!/usr/bin/env python3
"""Stealth verification harness for nodriver-reforged-browser-mcp.
...
from nodriver_reforged_browser_mcp.browser import BridgeBrowser  # noqa: E402
from nodriver_reforged_browser_mcp.proxy import parse_proxy  # noqa: E402
